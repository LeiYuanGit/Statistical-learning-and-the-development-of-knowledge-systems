...
- [Analysis 2_CHAID trees_N_M.Rmd](Markdown/Data-cleaning.md) This code grows CHAID trees for the N and More tasks. This is to verify that the trees generated by the ctree function are correct.  
